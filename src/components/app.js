          ...
          <div className="vh-100 w-100 white bg-brand-primary flex items-center pa4">
            <div className="flex vh-100 mw8 center flex-column-m flex-row-l flex-column">
              <div className="flex flex-1 flex-column justify-center-l justify-end-m justify-end white flex-wrap">
                ...
                <div className="mt3">Currently, looking for a junior develper position, a recent <a rel="noopener noreferrer" target="_blank" href="https://generalassemb.ly/education/software-engineering-immersive/atlanta">General Assembly</a>, graduate I'm seeking remote work and open to relocation.</div>
                <div className="mt3">In my free time, I enjoy <a rel="noopener noreferrer" target="_blank" href="https://www.instagram.com/rai_sylvester/">family time</a>, <a rel="noopener noreferrer" target="_blank" href="https://www.othisitraining.com/">weightlifting</a>, and playing video games <a rel="noopener noreferrer" target="_blank" href="https://store.world-8.com/">World-8</a>.</div>
              </div>
